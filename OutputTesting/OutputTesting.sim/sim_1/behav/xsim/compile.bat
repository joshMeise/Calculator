...
REM
REM Generated by Vivado on Mon May 27 16:19:25 -0400 2024
...
echo "xvhdl --incr --relax -prj output_tb_vhdl.prj"
call xvhdl  --incr --relax -prj output_tb_vhdl.prj -log xvhdl.log
