...
HD_PWD='O:/ENGS31/Proj/OutputTesting/OutputTesting.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log output.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source output.tcl -notrace
