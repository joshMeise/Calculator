...
set_property PACKAGE_PIN V17 [get_ports {inputExtPort[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inputExtPort[0]}]
## SWITCH 1
set_property PACKAGE_PIN V16 [get_ports {inputExtPort[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inputExtPort[1]}]
## SWITCH 2
set_property PACKAGE_PIN W16 [get_ports {inputExtPort[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inputExtPort[2]}]
## SWITCH 3
set_property PACKAGE_PIN W17 [get_ports {inputExtPort[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inputExtPort[3]}]
## SWITCH 4
set_property PACKAGE_PIN W15 [get_ports {inputExtPort[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inputExtPort[4]}]
## SWITCH 5
set_property PACKAGE_PIN V15 [get_ports {inputExtPort[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inputExtPort[5]}]
## SWITCH 6
set_property PACKAGE_PIN W14 [get_ports {inputExtPort[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inputExtPort[6]}]
## SWITCH 7
