...
REM
REM Generated by Vivado on Sun May 26 13:03:32 -0400 2024
...
echo "xvhdl --incr --relax -prj input_tb_vhdl.prj"
call xvhdl  --incr --relax -prj input_tb_vhdl.prj -log xvhdl.log
